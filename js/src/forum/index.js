...
app.initializers.add('jslirola-login2seeplus', function () {
    ...
    extend(CommentPost.prototype, 'content', function (list) {
        ...
        let oldContent = list.find(e => e.attrs.className == 'Post-body').children.find(e => e.tag == "<").children;
        ...
        list.find(e => e.attrs.className == 'Post-body').children =
            list.find(e => e.attrs.className == 'Post-body').children.map(e => e.tag == "<" ? m.trust(newContent) : e);
